...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relatives items-start justify-between md:px-36 px-8 md:pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p>
            Course by{' '}
            <span className="text-blue-600 underline">VrushaliAPoojary</span>
          </p>
